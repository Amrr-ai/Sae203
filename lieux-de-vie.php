...
<head>
    ...
    <title>Lieux de vie - BUT MMI - SAÉ 203</title>
    ...
    <main class="conteneur-principal conteneur-1280">
        ...
        <section>
            ...
            <ul class="liste-lieux">
                <li>
                    <div>
                        <img src="https://placehold.co/522x435" alt="Bibliothèque universitaire">
                    </div>
                ...
                <li>
                    <div>
                        <img src="https://placehold.co/522x435" alt="Restaurant universitaire">
                    </div>
                    <section class="textes">
                ...
                <li>
                    <div>
                        <img src="https://placehold.co/522x435" alt="Fablab">
                    </div>
                    <section class="textes">

...
<body>
    ...
    <header class="bg-white shadow">
        <div class="mx-auto max-w-7xl py-3 px-4 justify-between flex">
            <div>
                <p class="text-3xl font-bold text-gray-900">Liste des articles</p>
                ...
                <table class="w-full bg-white rounded-lg overflow-hidden border-collapse shadow">
                    <thead class="bg-gray-100">
                        <tr>
                            ...
                            <th class="font-bold pl-8 py-5 text-left text-ellipsis">Chapô</th>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr class="odd:bg-neutral-50  border-b-2 border-b-gray-100 last:border-b-0 first:border-t-2 first:border-t-gray-200">
                                    ...
                                    <td class="pl-8 p-4" data-label="Titre"><?php echo htmlspecialchars($element["titre_article"]); ?></td>
                                    <td class="pl-8 p-4" data-label="Chapô"><?php echo htmlspecialchars($element["chapo_article"]); ?></td>
                                    ...
                                    <td class="pl-8 p-4" data-label="Auteur">
                                        <?php echo htmlspecialchars($auteur_article); ?>
                                    </td>
                                    <td class="pl-8 p-4">
